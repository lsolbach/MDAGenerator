...
//	}
  ...
  protected IPackage initPackage(IPackage p, org.soulspace.xmi.marshal.Package xmiPackage) {
  ...
  protected IOperation initOperation(IOperation o, org.soulspace.xmi.marshal.Operation xmiOperation) {
    ...
    if(cf != null) {
      o.setReturnType(cf);    	
    	...
    	System.err.println("ERROR: The return type of method " + o.getName() + " is not set!");
    }
      ...
      if (aeI.getAssociationEnd_participant() != null) {
        ...
        while (e2.hasMoreElements()) {
      	...
      	if(!ae.getMultiplicity().getHigh().equals("1")) {
        	System.out.println("INFO: The multiplicity of an  AssociationEnd with Qualifiers should be 0..1 for AssociationEnd id: " + ae.getId());      		
      	}
